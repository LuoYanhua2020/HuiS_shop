...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"聚新商城","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 11 */
/*!**************************************!*\
  !*** D:/Vue/uniapp/聚新商城/util/api.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myRequest = void 0; // 声明BASE_URL，域名的前缀
var BASE_URL = "http://47.56.173.44/shopdemo/public/index.php/addons/xshop";
...
/* 12 */
/*!*****************************************!*\
  !*** D:/Vue/uniapp/聚新商城/store/store.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    setUserModel: function setUserModel(state, Model) {
      state.UserList = Model;
      // console.log(state.UserList)
    },
    // 定义一个清除UserList的方法
    removeUserModel: function removeUserModel(state) {
      state.UserList = [];
    } },

  // 拿取数据调用：this.$store.getters.（方法名）
  getters: {
    getUserModel: function getUserModel(state) {
      // 返回改变后的数据结构
